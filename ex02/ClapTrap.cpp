...
/*   Updated: 2025/02/26 16:46:59 by phartman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap& ClapTrap::operator=(const ClapTrap &other){
	std::cout <<BLUE << "ClapTrap assignation operator called" << std::endl;
	if (this != &other){
...
void ClapTrap::attack(const std::string& target){
	if (this->_energyPoints == 0){
		std::cout <<BLUE << "ClapTrap" << this->_name << " is out of energy!" << std::endl;
		return;
	}
	this->_energyPoints--;
...
void ClapTrap::takeDamage(unsigned int amount){
	if (this->_hitPoints == 0){
		std::cout <<BLUE << "ClapTrap " << this->_name << " is already dead!" << std::endl;
		return;
	}
